...
class SimpleCityScraper:
    ...
    def search_model_in_csv(self, creator_name: str, csv_path: str = None):
    ...
    def search_multiple_models_in_csv(self, creator_name: str, csv_path: str = None, max_results: int = 5):
